...
def main():
    ...
    train_path, valid_path = version_dir / "train.csv", version_dir / "valid.csv"
    test_candidates = [version_dir / "test.csv", version_dir / "test (1).csv"]
    ...
    output_dir = version_dir / f"market_free_{args.feature_set}_features"
